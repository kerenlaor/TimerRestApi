...
export interface TimerCountdownResponse {
  id?: string;
  numberOfSecondsLeft?: number;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @request GET:/api/timers
     */
    getAllTimers: (
      query: {
        /** page number to get timers */
        pageNumber: number;
      },
      params: RequestParams = {},
    ) =>
      this.request<TimerResponse, Error>({
        path: `/api/timers`,
        method: "GET",
        query: query,
        format: "json",
     ...
     *
     * @tags timer
     * @name GetTimerCountdownById
     * @summary Get number of seconds remaining in timer.
     * @request GET:/api/timers/{id}
     */
    getTimerCountdownById: (
      id: string,
      query: {
        /** page number to get timers */
        pageNumber: number;
      ...
      this.request<TimerCountdownResponse, Error>({
        path: `/api/timers/${id}`,
        method: "GET",
        query: query,
        format: "json",
     ...
     *
     * @tags timer
     * @name StartNewTimerCountdown
     * @summary post new timer request
     * @request POST:/api/timers/outpost
     */
    startNewTimerCountdown: (data: TimerRequest, params: RequestParams = {}) =>
      this.request<TimerCountdownResponse, Error>({
        path: `/api/timers/outpost`,
        method: "POST",
        body: data,
